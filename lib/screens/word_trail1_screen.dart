...
import 'word_trail2_screen.dart';

class WordTrail1Screen extends StatefulWidget {
  const WordTrail1Screen({super.key});

  @override
  State<WordTrail1Screen> createState() => _WordTrail1ScreenState();
}

class _WordTrail1ScreenState extends State<WordTrail1Screen> {
          ...
          children: [
            ...
            const Padding(
              ...
              child: Align(
                ...
                child: Text(
                  'What does their word make you think of?',
            ...
            const Padding(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  'It could be a memory, a feeling, or just your gut response. Let your mind wander.',
                  style: TextStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const WordTrail2Screen(),
                          ),
                        );
                      },
            ...
            const Spacer(), // ✅ Push nav bar at bottom
