...
import 'word_trail3_screen.dart'; // ✅ Make sure the import path is correct!

class WordTrail2Screen extends StatefulWidget {
  const WordTrail2Screen({super.key});

  @override
  State<WordTrail2Screen> createState() => _WordTrail2ScreenState();
}

class _WordTrail2ScreenState extends State<WordTrail2Screen> {
          ...
          children: [
            ...
            const Padding(
              ...
              child: Align(
                ...
                child: Text(
                  'Play a word that connects any two or more words already played.',
            ...
            const Padding(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  'Look for a link, a pattern, a shared vibe – whatever spark you find',
                  style: TextStyle(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const WordTrail3Screen(),
                          ),
                        );
                      },
            ...
            const Spacer(), // ✅ Push bottom nav to end
